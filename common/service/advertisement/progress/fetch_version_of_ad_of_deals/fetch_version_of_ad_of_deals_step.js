...
const { FetchVersionOfADOfDeals } = require('../../business/fetch_version_of_ad_of_deals')

class FetchVersionOfADOfDealsStep {
  constructor() {
    this._rsp = undefined
    this._from = 'FetchVersionOfADOfDealsStep'

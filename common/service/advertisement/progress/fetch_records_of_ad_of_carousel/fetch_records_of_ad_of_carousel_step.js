...
const { FetchRecordsOfADOfCarousel } = require('../../business/fetch_records_of_ad_of_carousel')

class FetchRecordsOfADOfCarouselStep {
  constructor() {
    this._rsp = undefined
    this._from = 'FetchRecordsOfADOfCarouselStep'
...
module.exports = {
  FetchRecordsOfADOfCarouselStep
}
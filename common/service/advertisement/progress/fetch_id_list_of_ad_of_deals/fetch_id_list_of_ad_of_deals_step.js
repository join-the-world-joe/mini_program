...
const {FetchIdListOfADOfDeals} = require('../../business/fetch_id_list_of_ad_of_deals')

class FetchIdListOfADOfDealsStep {
  constructor() {
    this._rsp = undefined
    this._from = 'FetchIdListOfADOfDealsStep'
